export const Presets = {
    ...
    "cyber-bass": {
        ...
        params: {
            ...
            noise: { type: 'white', level: 0 },
            filter: { type: 'lowpass', cutoff: 200, res: 5, keytrack: 0, slope: 12 },
    ...
    "neon-pad": {
        ...
        params: {
            ...
            filter: { type: 'lowpass', cutoff: 800, res: 2, keytrack: 0, slope: 12 },
    ...
    "acid-pluck": {
        ...
        params: {
            ...
            vco3: { on: false, wave: 'sine', oct: 0, tune: 0, level: 0 },
            noise: { type: 'white', level: 0 },
            filter: { type: 'lowpass', cutoff: 80, res: 18, keytrack: 0, slope: 12 },
    ...
    "deep-sub": {
        ...
        params: {
            ...
            filter: { type: 'lowpass', cutoff: 350, res: 1, keytrack: 0, slope: 12 },
    ...
    "prodigy-lead": {
        ...
        params: {
            ...
            noise: { type: 'white', level: 0 },
            filter: { type: 'lowpass', cutoff: 150, res: 14, keytrack: 0, slope: 12 },
    ...
    "wobble-bass": {
        ...
        params: {
            ...
            lfo1: { sync: 0, wave: 'sine', rate: 3, pitch: 0, cutoff: 1400 },
            lfo2: { sync: 0, wave: 'sine', rate: 5, amp: 0 },
            effects: {
    ...
    "kick-drum": {
        ...
        params: {
            ...
            filter: { type: 'lowpass', cutoff: 900, res: 1, keytrack: 0, slope: 12 },
    ...
    "sci-fi-computer": {
        ...
        params: {
            ...
            lfo1: { sync: 0, wave: 'random', rate: 12, pitch: 200, cutoff: 1500 },
            lfo2: { sync: 0, wave: 'sine', rate: 5, amp: 0 },
            effects: {
                'dist-on': false, 'dist-drive': 0,
                'chorus-on': false, 'chorus-rate': 0.6, 'chorus-depth': 0.5, 'chorus-mix': 0.5,
