export class UIController {
    ...
    getParamBindings() {
        return [
            ...
            { id: 'vco1-tune', param: 'vco1.tune', type: 'range' },
            { id: 'vco1-level', param: 'vco1.level', type: 'range' },
            { id: 'vco1-pw', param: 'vco1.pw', type: 'range' },
            { id: 'vco1-pwm', param: 'vco1.pwm', type: 'range' },
            
            // VCO 2'vco2-on', group: 'vco2', param: 'on', type: 'checkbox' },
            ...
            { id: 'glide-time', param: 'master.glide', type: 'range' },
            { id: 'seq-swing', param: 'master.swing', type: 'range' },
            { id: 'arp-on', param: 'master.arpOn', type: 'checkbox' },
            { id: 'arp-mode', param: 'master.arpMode', type: 'select' },
            
            // LFOs
            { name: 'lfo1-wave', param: 'lfo1.wave', type: 'radio' },
            { id: 'lfo1-rate', param: 'lfo1.rate', type: 'range' },
